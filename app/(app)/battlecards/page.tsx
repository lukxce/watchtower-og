  ...
  return (
    <main className="main solo">
      <section className="feed">
        <h1>Battlecards</h1>
        <p className="sub">
          One card per competitor: positioning, strengths, vulnerabilities, how you win, and the question to ask in
          discovery. Numbers pull from live signals · strategy generated by Claude · updated {ago(gen.generated_at)}.
        </p>
        {rows.map((r) => {
