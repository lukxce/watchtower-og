...
export const POSTS: BlogPost[] = [
  {
    ...
    dek: 'Three hostnames, no announcement, and a content trail that made the shape obvious.',
    date: '2026-08-16',
    readMins: 5,
    ...
    body: [
      ...
      'It is tempting to read interviewer-v2 as a second attempt, and we drafted exactly that before checking. It does not hold: v2 is Klue\u2019s platform-wide naming convention, visible in v2.app.klue.com and in hundreds of frontend-v2 preview hostnames. The v2 refers to their platform generation, not to an iteration count on this feature. The inference was available, plausible, and wrong, which is the failure mode this whole discipline exists to avoid.',
      'What does hold is volume of commitment. Three separate hostnames given over to interviewing and voice is not somebody trying an idea on a Friday. And mcp-adapter.app.klue.com resolves on their production hostname, not just staging, so Model Context Protocol support is not a research project for them either.',
